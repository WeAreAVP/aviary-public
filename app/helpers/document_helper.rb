...
module DocumentHelper
  ...
  def description_simple_fields
    %i[description_publisher_sms description_rights_statement_sms description_source_sms description_agent_sms description_date_sms description_coverage_sms description_language_sms description_description_sms
