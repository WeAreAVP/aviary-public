...
module Blacklight::SearchHelper
  ...
  def search_results(user_params)
    ...
    builder.session_solr = session[:searched_keywords]
    builder.current_user = current_user
    builder.current_params = user_params if user_params.present?
    builder.current_user = current_user
    builder.current_organization = current_organization
    builder.user_ip = request.ip
    builder.request_is_xhr = request.xhr?
