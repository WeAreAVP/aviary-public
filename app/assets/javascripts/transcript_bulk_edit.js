/**
 *  Transcript Bulk Edit Operations
 *
...
function TranscriptBulkEdit(ids_session_raw) {
    selfRBE = this;
    selfRBE.app_helper = {};
    ...
    this.bulk_file_transcript_edit = function (response, container) {
        $('#num_of_rec_updated').html(selfRBE.ids_session.length);
    ...
    const update_bulk_edit_view = function (selected_type) {
        ...
        if (selected_type == 'bulk_delete') {
            ...
            $('#confirm_msg_pop_bulk').html(' delete the transcripts listed below');
        }
            ...
            $('#confirm_msg_pop_bulk').html(' change the access status of the transcripts listed below');

        }
        else if (selected_type == 'transcript_caption') {
            $('.transcript_caption_content').removeClass('d-none');
            $('#bulk_edit_type_of_bulk_operation').val('transcript_caption');
