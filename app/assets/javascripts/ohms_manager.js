...
function OhmsManager() {
    ...
    let initTableListing = function () {
        let config = {
            ...
            ajax: {
                url: $('#ohms_thesaurus_list_table').data('url'),
                type: 'POST'
            },
            columnDefs: [
        ...
        appHelper.serverSideDatatable('#ohms_thesaurus_list_table', that, config, $('#ohms_thesaurus_list_table').data('url'))
    };
