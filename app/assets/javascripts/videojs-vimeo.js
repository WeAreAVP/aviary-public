  ...
  `;
    ...
    class Vimeo extends Tech {
        ...
        initVimeoPlayer() {
            ...
            ['play', 'pause', 'ended', 'timeupdate', 'progress', 'seeked', 'loadedmetadata', 'playing', 'rendererready'].forEach(e => {
        ...
        setVolume(volume) {
            ...
            $('.vjs-volume-level').css('width', width + '%');
        ...
        muted() {
            return this._vimeoState.volume.volume === 0;
        }

        setMuted(mute) {
            if (mute) {
                this._vimeoState.volume.volume = 0;
                this._player.setVolume(0);
                setTimeout(function () {
                    $('.vjs-mute-control').removeClass('vjs-vol-3').addClass('vjs-vol-0');
                    $('.vjs-mute-control').attr('title', 'Unmute');
                    $('.vjs-mute-control .vjs-control-text').html('Unmute');
                    $('.vjs-volume-level').css('width', '0%');

                }, 200);
            } else {
                this._vimeoState.volume.volume = 1;
                this._player.setVolume(1);
                setTimeout(function () {
                    $('.vjs-mute-control').removeClass('vjs-vol-0').addClass('vjs-vol-3');
                    $('.vjs-mute-control').attr('title', 'Mute');
                    $('.vjs-mute-control .vjs-control-text').html('Mute');
                    $('.vjs-volume-level').css('width', '100%');
                }, 200);
            }
            return this._vimeoState.volume.volume === 0;
        }
