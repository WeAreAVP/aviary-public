class AddEmbedCodeTypeInResourceFile < ActiveRecord::Migration[7.1]
    def change
      Organization.all.each do |org|
        ...
        if resource_file_display_column.present?
          ...
          begin
            unless display_keys.include?('embed_code_type_ss')
              resource_file_display_column['columns_status'][resource_file_display_column['columns_status'].count] = { 'status' => 'true', 'value' => 'embed_code_type_ss', 'sort_name' => 'true' }
            end
